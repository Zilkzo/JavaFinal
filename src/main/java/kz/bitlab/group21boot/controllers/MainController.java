...
//__________________DETAILS___________________________
   ...
   // ______________________ADDING USER AND MODERATOR_________________________
    ...
    {
        Users user = getUserData();
        List<Basket> basket = basketRepository.findAllByAuthor_Id(user.getId());
    ...
    @GetMapping(path = "/addToBasket/{id}")
    public String addToBasket(Model model,
        ...
        Users u  = getUserData();
            ...
            Basket basket1 = new Basket(u,item);
